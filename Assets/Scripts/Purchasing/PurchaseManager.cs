...
public class PurchaseManager : MonoBehaviour, IStoreListener
{
    public static PurchaseManager instance;
     ...
     {
          if (C_PRODUCTS.Length >= (currentProductIndex + 1) && String.Equals(args.purchasedProduct.definition.id, C_PRODUCTS[currentProductIndex], StringComparison.Ordinal))
               OnSuccessC(args);
          else if (NC_PRODUCTS.Length >= (currentProductIndex + 1) && String.Equals(args.purchasedProduct.definition.id, NC_PRODUCTS[currentProductIndex], StringComparison.Ordinal))
               OnSuccessNC(args);
