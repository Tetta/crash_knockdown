...
namespace I2.Loc
{
	...
	public class TermsPopup_Drawer : PropertyDrawer 
	{
        ...
        public static bool ShowGUICached(Rect position, SerializedProperty property, GUIContent label, LanguageSource source, string filter, ref GUIContent[] terms_Contexts, ref int framesBeforeUpdating, ref string prevFilter)
		{
